...
public class MegaManMain {
	...
	public static void main(String[] args) throws InterruptedException, IOException  {
		...
		UpdatedGraphicsManager updatedMan = new UpdatedGraphicsManager();  // Draws new game objects
		...
		while(playAgain != 1) {
			...
			LevelState level1State = new NewLevel1State(1, frame, gameStatus, gameLogic, inputHandler, updatedMan, soundMan);
			LevelState level2State = new NewLevel2State(2, frame, gameStatus, gameLogic, inputHandler, updatedMan, soundMan);
			LevelState level3State = new Level3State(3, frame, gameStatus, gameLogic, inputHandler, updatedMan, soundMan); // added level3State
			LevelState level4State = new Level4State(4, frame, gameStatus, gameLogic, inputHandler, updatedMan, soundMan);// added level4State 
